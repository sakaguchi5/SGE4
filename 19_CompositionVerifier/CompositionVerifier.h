...
public:
    ...
    [[nodiscard]] const ::sge4_5::composition::FrozenComposition& Artifact() const noexcept { return artifact_; }
...
private:
    ...
    VerifiedFrozenComposition(
        ::sge4_5::composition::FrozenComposition artifact,
    ...
    ::sge4_5::composition::FrozenComposition artifact_;
