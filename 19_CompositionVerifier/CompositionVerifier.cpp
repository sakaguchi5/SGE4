...
namespace sge4_5::composition::canonical::verification
{
namespace
{
    ...
    const VerifiedCompositionPlan& verified)
{
    ...
    {
        ::sge4_5::composition::EmbeddedLeafInput embedded;
    ...
    auto artifact = ::sge4_5::composition::FrozenCompositionWriter::Write(std::move(input));
    if (!artifact)
        return Failure<std::vector<std::byte>>(
...
{
    auto artifactResult = ::sge4_5::composition::FrozenCompositionReader::Read(std::move(bytes));
    if (!artifactResult)
