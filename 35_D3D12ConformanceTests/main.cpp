...
int main()
{
    using Op = sge4::package::d3d12_v13::D3D12OperationCode;
    ...
    for (auto op : required)
        if (!sge4::d3d12::D3D12Backend::SupportsOperation(op)) { std::cerr << "required operation unsupported\n"; return 1; }
    if (sge4::d3d12::D3D12Backend::SupportsOperation(static_cast<Op>(0x0002ffff))) return 2;
