...
struct FrozenHierarchyLeafV1 final
{
    ...
    std::uint32_t primaryInputElementCount=0,primaryOutputElementCount=0;
    std::uint32_t secondaryInputElementCount=0,secondaryOutputElementCount=0;
    ...
    std::uint32_t expectedDynamicSlotCount=0;
    std::uint32_t expectedExternalSlotCount=0;
...
[[nodiscard]] base::Result<void,LeafCompileErrorV1> SealFrozenHierarchyLeafBindingV1(FrozenHierarchyLeafV1& value);
