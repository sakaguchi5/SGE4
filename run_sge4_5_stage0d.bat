...
set "ROOT=%~dp0"
set "FINALDIR=%ROOT%build\sge4-5-stage0d"
...
echo ============================================================
echo SGE4-5 STAGE 0D FOUNDATION FREEZE PASSED
echo Independent solution/namespace: SemanticGpuEngine4-5 / sge4_5
echo Canonical corpus: 54 deterministic Packages
echo Target ABI: proven D3D12 Schema 17 / Runtime 17
echo Orchestration: CandidatePlanner is Package-free; SGE4_5Compiler alone lowers verifier-sealed Plans
