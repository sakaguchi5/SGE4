> Current status: Generalization 5により現行ProductionはSGE4UNI 2.5／SGE4INV 1.4へ進んだ。本書の2.2記述はGeneralization 2完成時点の契約記録であり、Conditional Region／SGE4INV 1.3の意味は維持される。
