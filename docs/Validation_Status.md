...
- Clang C++23 syntax-checked the changed CompilationInput, CandidatePlanner, SGE4Compiler, SGE3 Oracle, PlanningTests, and AuthorityTests translation units.
