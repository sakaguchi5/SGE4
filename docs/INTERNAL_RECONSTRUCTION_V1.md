...
> Status note: 本文はv1.4時点のSource reconstruction記録である。第9章で別作業として延期したmajor 2平坦化は、Frozen Composition ABI 2.0で完了した。現行Production形式は`SGE4UNI 2.4`であり、詳細は`FROZEN_COMPOSITION_ABI_2_0.md`を参照する。
