...
- CU4: implementation supplied — A/B/C incremental-history Candidate Family, Block-mask reconstruction, 18 chained invocations, 54 WARP executions and pairwise full-output equivalence.
- CU5: pending.
- CU6: pending.
...
Successful CU4 execution will establish:
