...
This ledger is monotonic. CU0-CU2 are implemented here; later invariants remain planned.
...
| S3-I06-S3-I15 | Planned | Leaf, Composition, WARP, recovery and measurement units are not included yet. |
