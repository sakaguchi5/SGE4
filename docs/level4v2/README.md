...
R0 Input Freeze = COMPLETE (package supplied; Owner gate pending)
...
6. `PROVEN_CAPABILITY_MATRIX_V1.md`
7. `RETAINED_REFERENCE_LAYOUT_V1.md`
8. `RECONSTRUCTION_ROADMAP_V1.md`
9. `EXTERNAL_EVIDENCE_INDEX_V1.md`
10. `PRE_V2_REPOSITORY_DECISION_V1.md`
...
No game-policy inference
No mutation of accepted Schema 17 / Runtime 17 evidence before migration proof
No deletion of Spiral reference projects until v2 reproduces their invariants
No public Spiral/CU names in the v2 Canonical vocabulary
```
