...
namespace runtime18 = sge4_5::composition::canonical::runtime_v1;
namespace contract = sge4_5::composition::canonical;
...
int RunDiamond(Evidence& evidence)
{
    ...
    if (loaded.Value().LeafCount() != 4 ||
        loaded.Value().State() != sge4_5::runtime::DeviceRuntimeState::Active)
        return 4;
...
std::string EvidenceManifest(const Evidence& evidence)
{
    ...
    output << "diamond-output-sha256="
           << sge4_5::base::ToHex(sge4_5::base::Sha256(evidence.diamondOutput)) << '\n';
    output << "linear-output-sha256="
           << sge4_5::base::ToHex(sge4_5::base::Sha256(evidence.linearOutput)) << '\n';
    output << "fanout-left-sha256="
           << sge4_5::base::ToHex(sge4_5::base::Sha256(evidence.fanoutLeft)) << '\n';
    output << "fanout-right-sha256="
           << sge4_5::base::ToHex(sge4_5::base::Sha256(evidence.fanoutRight)) << '\n';
    output << "multi-input-output-sha256="
           << sge4_5::base::ToHex(sge4_5::base::Sha256(evidence.multiInputOutput)) << '\n';
    output << "independent-a-sha256="
           << sge4_5::base::ToHex(sge4_5::base::Sha256(evidence.independentA)) << '\n';
    output << "independent-b-sha256="
           << sge4_5::base::ToHex(sge4_5::base::Sha256(evidence.independentB)) << '\n';
    const auto body = output.str();
    output << "evidence-aggregate=" << sge4_5::base::ToHex(sge4_5::base::Sha256(
