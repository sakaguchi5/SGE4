...
public:
    ...
    [[nodiscard]] base::Result<::sge4::runtime::DeviceRecoveryReport, DomainError> RecoverNativeDomain(
        ::sge4::runtime::DeviceRecoveryMode mode);

private:
    friend base::Result<SharedDeviceDomain, DomainError> MaterializeSharedDeviceDomain(
        verification::VerifiedFrozenComposition, d3d12::D3D12Backend&, ::sge4::runtime::ISurfaceHost*);
