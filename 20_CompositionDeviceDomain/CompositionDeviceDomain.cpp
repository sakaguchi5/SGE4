...
base::Result<::sge4::runtime::DeviceRecoveryReport, DomainError>
SharedDeviceDomain::RecoverNativeDomain(::sge4::runtime::DeviceRecoveryMode mode)
{
    ...
    if (!recovered)
        return base::Result<::sge4::runtime::DeviceRecoveryReport, DomainError>::Failure(
            Error(recovered.Error()));
    return base::Result<::sge4::runtime::DeviceRecoveryReport, DomainError>::Success(
