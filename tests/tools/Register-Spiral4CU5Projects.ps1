...
$projects = @(
    [pscustomobject]@{
        Name = '132_Spiral4CandidateFamilyRuntime'
        Path = '132_Spiral4CandidateFamilyRuntime\132_Spiral4CandidateFamilyRuntime.vcxproj'
        Guid = '{00000084-0000-5000-8000-000000000084}'
    },
    [pscustomobject]@{
        Name = '143_Spiral4ArchitectureQualificationTests'
        Path = '143_Spiral4ArchitectureQualificationTests\143_Spiral4ArchitectureQualificationTests.vcxproj'
        Guid = '{0000008F-0000-5000-8000-00000000008F}'
    }
)
...
foreach ($project in $projects) {
    ...
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) {
        throw "Spiral 4 CU5 project is missing: $($project.Path)"
    }
...
Write-Host 'Spiral 4 CU5 projects registered in SemanticGpuEngine4-5.sln.'
