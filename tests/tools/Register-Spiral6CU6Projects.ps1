...
$projects = @(
    [pscustomobject]@{Name='170_Spiral6PerformanceExperiment';Path='170_Spiral6PerformanceExperiment\170_Spiral6PerformanceExperiment.vcxproj';Guid='{000000AA-0000-5000-8000-0000000000AA}'},
    [pscustomobject]@{Name='171_Spiral6PerformanceTests';Path='171_Spiral6PerformanceTests\171_Spiral6PerformanceTests.vcxproj';Guid='{000000AB-0000-5000-8000-0000000000AB}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 6 CU6 project missing: $($project.Path)" }
...
Write-Host 'Spiral 6 CU6 V2 relative-map projects registered in SemanticGpuEngine4-5.sln.'
