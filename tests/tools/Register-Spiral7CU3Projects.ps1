...
$projects = @(
    [pscustomobject]@{Name='175_SparseTemporalDeltaLoweringCandidate';Path='175_SparseTemporalDeltaLoweringCandidate\175_SparseTemporalDeltaLoweringCandidate.vcxproj';Guid='{000000AF-0000-5000-8000-0000000000AF}'},
    [pscustomobject]@{Name='176_SparseTemporalDeltaLoweringPlanner';Path='176_SparseTemporalDeltaLoweringPlanner\176_SparseTemporalDeltaLoweringPlanner.vcxproj';Guid='{000000B0-0000-5000-8000-0000000000B0}'},
    [pscustomobject]@{Name='177_SparseTemporalDeltaLoweringVerifier';Path='177_SparseTemporalDeltaLoweringVerifier\177_SparseTemporalDeltaLoweringVerifier.vcxproj';Guid='{000000B1-0000-5000-8000-0000000000B1}'},
    [pscustomobject]@{Name='183_Spiral7AuthorityMutationTests';Path='183_Spiral7AuthorityMutationTests\183_Spiral7AuthorityMutationTests.vcxproj';Guid='{000000B7-0000-5000-8000-0000000000B7}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 7 CU3 project missing: $($project.Path)" }
...
Write-Host 'Spiral 7 CU3 projects registered in SemanticGpuEngine4-5.sln.'
