...
$projects = @(
    [pscustomobject]@{Name='185_Spiral7DeltaFamilyRuntime';Path='185_Spiral7DeltaFamilyRuntime\185_Spiral7DeltaFamilyRuntime.vcxproj';Guid='{000000B9-0000-5000-8000-0000000000B9}'},
    [pscustomobject]@{Name='186_Spiral7ArchitectureQualificationTests';Path='186_Spiral7ArchitectureQualificationTests\186_Spiral7ArchitectureQualificationTests.vcxproj';Guid='{000000BA-0000-5000-8000-0000000000BA}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 7 CU5 project missing: $($project.Path)" }
...
Write-Host 'Spiral 7 CU5 projects registered in SemanticGpuEngine4-5.sln.'
