...
$requiredFiles = @(
    ...
    'tests/Run-Spiral1CU2.ps1',
    'tests/tools/Verify-Spiral1CU2.ps1',
    ...
    'tests/Run-Spiral1CU3.ps1',
    'tests/tools/Verify-Spiral1CU3.ps1',
    ...
    'tests/Run-Spiral2FinalQualification.ps1',
    'tests/tools/Verify-Spiral2FinalAuthority.ps1',
