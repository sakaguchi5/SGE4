...
$projects = @(
    [pscustomobject]@{Name='137_TemporalLoweringCandidate';Path='137_TemporalLoweringCandidate\137_TemporalLoweringCandidate.vcxproj';Guid='{00000089-0000-5000-8000-000000000089}'},
    [pscustomobject]@{Name='138_TemporalLoweringPlanner';Path='138_TemporalLoweringPlanner\138_TemporalLoweringPlanner.vcxproj';Guid='{0000008A-0000-5000-8000-00000000008A}'},
    [pscustomobject]@{Name='139_TemporalLoweringVerifier';Path='139_TemporalLoweringVerifier\139_TemporalLoweringVerifier.vcxproj';Guid='{0000008B-0000-5000-8000-00000000008B}'},
    [pscustomobject]@{Name='146_Spiral5AuthorityMutationTests';Path='146_Spiral5AuthorityMutationTests\146_Spiral5AuthorityMutationTests.vcxproj';Guid='{00000092-0000-5000-8000-000000000092}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 5 CU3 project missing: $($project.Path)" }
...
Write-Host 'Spiral 5 CU3 projects registered in SemanticGpuEngine4-5.sln.'
