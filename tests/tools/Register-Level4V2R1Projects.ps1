...
$projects = @(
    [pscustomobject]@{Name='189_Level4V2CanonicalVocabulary';Path='189_Level4V2CanonicalVocabulary\189_Level4V2CanonicalVocabulary.vcxproj';Guid='{000000BD-0000-5000-8000-0000000000BD}'},
    [pscustomobject]@{Name='190_Level4V2CanonicalVocabularyTests';Path='190_Level4V2CanonicalVocabularyTests\190_Level4V2CanonicalVocabularyTests.vcxproj';Guid='{000000BE-0000-5000-8000-0000000000BE}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Level 4 v2 R1 project missing: $($project.Path)" }
...
Write-Host 'Level 4 v2 R1 projects registered in SemanticGpuEngine4-5.sln.'
