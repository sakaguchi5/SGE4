...
$projects = @(
    [pscustomobject]@{Name='178_SparseTemporalDeltaCandidateFamily';Path='178_SparseTemporalDeltaCandidateFamily\178_SparseTemporalDeltaCandidateFamily.vcxproj';Guid='{000000B2-0000-5000-8000-0000000000B2}'},
    [pscustomobject]@{Name='179_SparseTemporalDeltaCandidateFamilyPlanner';Path='179_SparseTemporalDeltaCandidateFamilyPlanner\179_SparseTemporalDeltaCandidateFamilyPlanner.vcxproj';Guid='{000000B3-0000-5000-8000-0000000000B3}'},
    [pscustomobject]@{Name='180_SparseTemporalDeltaCandidateFamilyVerifier';Path='180_SparseTemporalDeltaCandidateFamilyVerifier\180_SparseTemporalDeltaCandidateFamilyVerifier.vcxproj';Guid='{000000B4-0000-5000-8000-0000000000B4}'},
    [pscustomobject]@{Name='181_Spiral7DeltaFamilyExecution';Path='181_Spiral7DeltaFamilyExecution\181_Spiral7DeltaFamilyExecution.vcxproj';Guid='{000000B5-0000-5000-8000-0000000000B5}'},
    [pscustomobject]@{Name='184_Spiral7CandidateFamilyTests';Path='184_Spiral7CandidateFamilyTests\184_Spiral7CandidateFamilyTests.vcxproj';Guid='{000000B8-0000-5000-8000-0000000000B8}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 7 CU4 project missing: $($project.Path)" }
...
Write-Host 'Spiral 7 CU4 projects registered in SemanticGpuEngine4-5.sln.'
