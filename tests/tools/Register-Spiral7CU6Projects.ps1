...
$projects = @(
    [pscustomobject]@{Name='187_Spiral7PerformanceExperiment';Path='187_Spiral7PerformanceExperiment\187_Spiral7PerformanceExperiment.vcxproj';Guid='{000000BB-0000-5000-8000-0000000000BB}'},
    [pscustomobject]@{Name='188_Spiral7PerformanceTests';Path='188_Spiral7PerformanceTests\188_Spiral7PerformanceTests.vcxproj';Guid='{000000BC-0000-5000-8000-0000000000BC}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 7 CU6 project missing: $($project.Path)" }
...
Write-Host 'Spiral 7 CU6 projects registered in SemanticGpuEngine4-5.sln.'
