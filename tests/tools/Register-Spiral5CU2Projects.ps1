...
$projects = @(
    [pscustomobject]@{Name='134_TemporalStateSemantic';Path='134_TemporalStateSemantic\134_TemporalStateSemantic.vcxproj';Guid='{00000086-0000-5000-8000-000000000086}'},
    [pscustomobject]@{Name='135_Spiral5TemporalContracts';Path='135_Spiral5TemporalContracts\135_Spiral5TemporalContracts.vcxproj';Guid='{00000087-0000-5000-8000-000000000087}'},
    [pscustomobject]@{Name='136_Spiral5TemporalExecution';Path='136_Spiral5TemporalExecution\136_Spiral5TemporalExecution.vcxproj';Guid='{00000088-0000-5000-8000-000000000088}'},
    [pscustomobject]@{Name='145_Spiral5TemporalArchitectureTests';Path='145_Spiral5TemporalArchitectureTests\145_Spiral5TemporalArchitectureTests.vcxproj';Guid='{00000091-0000-5000-8000-000000000091}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 5 CU2 project missing: $($project.Path)" }
...
Write-Host 'Spiral 5 CU2 projects registered in SemanticGpuEngine4-5.sln.'
