...
$projects = @(
    [pscustomobject]@{Name='172_SparseTemporalDeltaSemantic';Path='172_SparseTemporalDeltaSemantic\172_SparseTemporalDeltaSemantic.vcxproj';Guid='{000000AC-0000-5000-8000-0000000000AC}'},
    [pscustomobject]@{Name='173_Spiral7DeltaContracts';Path='173_Spiral7DeltaContracts\173_Spiral7DeltaContracts.vcxproj';Guid='{000000AD-0000-5000-8000-0000000000AD}'},
    [pscustomobject]@{Name='174_Spiral7DeltaExecution';Path='174_Spiral7DeltaExecution\174_Spiral7DeltaExecution.vcxproj';Guid='{000000AE-0000-5000-8000-0000000000AE}'},
    [pscustomobject]@{Name='182_Spiral7DeltaArchitectureTests';Path='182_Spiral7DeltaArchitectureTests\182_Spiral7DeltaArchitectureTests.vcxproj';Guid='{000000B6-0000-5000-8000-0000000000B6}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 7 CU2 project missing: $($project.Path)" }
...
Write-Host 'Spiral 7 CU2 projects registered in SemanticGpuEngine4-5.sln.'
