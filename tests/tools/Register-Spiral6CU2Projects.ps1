...
$projects = @(
    [pscustomobject]@{Name='154_SparseWorkSetSemantic';Path='154_SparseWorkSetSemantic\154_SparseWorkSetSemantic.vcxproj';Guid='{0000009A-0000-5000-8000-00000000009A}'},
    [pscustomobject]@{Name='155_Spiral6SparseContracts';Path='155_Spiral6SparseContracts\155_Spiral6SparseContracts.vcxproj';Guid='{0000009B-0000-5000-8000-00000000009B}'},
    [pscustomobject]@{Name='156_Spiral6SparseExecution';Path='156_Spiral6SparseExecution\156_Spiral6SparseExecution.vcxproj';Guid='{0000009C-0000-5000-8000-00000000009C}'},
    [pscustomobject]@{Name='166_Spiral6SparseArchitectureTests';Path='166_Spiral6SparseArchitectureTests\166_Spiral6SparseArchitectureTests.vcxproj';Guid='{000000A6-0000-5000-8000-0000000000A6}'}
)
foreach ($project in $projects) {
    $projectPath = Join-Path $root $project.Path
    if (-not (Test-Path -LiteralPath $projectPath -PathType Leaf)) { throw "Spiral 6 CU2 project missing: $($project.Path)" }
...
Write-Host 'Spiral 6 CU2 projects registered in SemanticGpuEngine4-5.sln.'
