...
Set-Content -LiteralPath $logPath -Value "SGE4 Level 4 v1 Final Integration Freeze`nStarted=$(Get-Date -Format o)" -Encoding UTF8
try {
    ...
    Write-Host 'Build root: SemanticGpuEngine4.sln is the sole canonical solution'
