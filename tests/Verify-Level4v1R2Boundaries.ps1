...
Assert-ExactReferences '47_CanonicalCompositionAuthorityTests' @(
    ...
    '12_SGE4_5Compiler', '16_FrozenCompositionArtifact', '17_CompositionContract',
...
Assert-SourceDoesNotContain '17_CompositionContract' @(
    ...
    'SGE4_5Compiler', 'PackageRuntime', 'D3D12Backend', 'CompositionRuntime',
...
Assert-SourceDoesNotContain '19_CompositionVerifier' @(
    'SemanticModel', 'SemanticAnalysis', 'CandidatePlanner', 'SGE4_5Compiler',
