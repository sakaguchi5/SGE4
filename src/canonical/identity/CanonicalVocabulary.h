...
struct PackageExecutionIdentityTagV1;
...
using OperationSequenceIdentity = CanonicalIdentityV1<OperationSequenceIdentityTagV1>;
using VerificationSealIdentity = CanonicalIdentityV1<VerificationSealIdentityTagV1>;
using PackageExecutionIdentity = CanonicalIdentityV1<PackageExecutionIdentityTagV1>;
