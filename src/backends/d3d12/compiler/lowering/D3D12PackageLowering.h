...
#include "../../../../canonical/base/Base.h"
#include "../../../../leaf/model/compilation/CompilationInput.h"
...
#include "../../../../leaf/model/semantic/SemanticModel.h"
#include "../../../../leaf/model/analysis/SemanticAnalysis.h"
#include "../target/TargetModel.h"
#include "../../../../leaf/model/plan/ExecutionPlanModel.h"
...
[[nodiscard]] base::Expected<FrozenComputePackageEvidenceV1, CompileError>
InspectFrozenComputePackageEvidenceV1(std::span<const std::byte> packageBytes);

[[nodiscard]] base::Expected<void, CompileError> ValidateLevel2Capability(
    const semantic::SemanticGraph& graph,
    const target::D3D12TargetProfile& targetProfile);

[[nodiscard]] base::Expected<ValidatedSourceStage, CompileError> ValidateSourceStage(
    const semantic::SemanticGraph& graph,
    const target::D3D12TargetProfile& targetProfile);

[[nodiscard]] base::Expected<ProgramCompilationStage, CompileError> CompileProgramStage(
...
[[nodiscard]] base::Expected<CompileOutput, CompileError> LowerVerifiedPlan(
    const semantic::SemanticGraph& graph,
    const target::D3D12TargetProfile& targetProfile,
