...
public:
    ...
    [[nodiscard]] base::Expected<void, SharedResourceError> PrepareForEndpoint(CompositionEndpointId endpoint);
    [[nodiscard]] base::Expected<void, SharedResourceError> UpdateAfterRelease(
...
[[nodiscard]] base::Expected<SharedResourceTable, SharedResourceError> MaterializeSharedResources(
