...
#include "../../../leaf/artifact/package/PackageFormat.h"
...
struct D3D12PackageDescription final
{
    ...
    // Independent-verifier certificate. Required for newly frozen SGE4 Leaves,
    // but intentionally excluded from the execution digest.
