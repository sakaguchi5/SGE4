...
inline constexpr std::array FrozenCompositionSectionKinds = {
    FrozenCompositionSectionKind::Manifest, FrozenCompositionSectionKind::LeafTable,
    FrozenCompositionSectionKind::LeafBytes, FrozenCompositionSectionKind::ContractData,
    FrozenCompositionSectionKind::VerifiedDecisionData, FrozenCompositionSectionKind::VerificationCertificate};
static_assert(base::ValuesAreUnique(FrozenCompositionSectionKinds,
    [](FrozenCompositionSectionKind value) { return std::to_underlying(value); }));
static_assert(base::ValuesAreStrictlyIncreasing(FrozenCompositionSectionKinds,
    [](FrozenCompositionSectionKind value) { return std::to_underlying(value); }));
