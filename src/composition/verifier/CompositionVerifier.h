...
private:
    ...
    friend base::Expected<VerifiedCompositionPlan, VerificationError>
...
[[nodiscard]] base::Expected<VerifiedCompositionPlan, VerificationError>
VerifyAndSeal(
    const ValidatedCompositionContract& contract,
    const planning::RawCompositionPlan& rawPlan);

[[nodiscard]] base::Expected<void, VerificationError>
...
[[nodiscard]] base::Expected<VerificationCertificate, VerificationError>
