...
#include "../../canonical/base/StrongId.h"
...
private:
    ...
    friend base::Expected<ValidatedCompositionContract, ContractError>
...
[[nodiscard]] base::Expected<ValidatedCompositionContract, ContractError>
...
[[nodiscard]] base::Expected<void, ContractError>
...
[[nodiscard]] base::Expected<PackageCompositionContract, ContractError>
