...
inline constexpr std::array PackageSectionKinds = {
    SectionKind::Manifest, SectionKind::InvocationSchema, SectionKind::OperationStreamTable,
    SectionKind::OperationTable, SectionKind::OperationPayload, SectionKind::InitialData,
    SectionKind::ShaderData, SectionKind::NativeObjectData, SectionKind::D3D12TargetProfile,
    SectionKind::D3D12ResourceTable, SectionKind::D3D12AllocationTable, SectionKind::D3D12ViewTable,
    SectionKind::D3D12ShaderTable, SectionKind::D3D12ProgramTable, SectionKind::D3D12BindingLayoutTable,
    SectionKind::D3D12ExecutableTable, SectionKind::D3D12RasterCommandTable, SectionKind::D3D12DescriptorPlan,
    SectionKind::D3D12DynamicSlotTable, SectionKind::D3D12ExternalSlotTable, SectionKind::D3D12SurfaceSlotTable,
    SectionKind::D3D12VertexElementTable, SectionKind::D3D12AttachmentOperationTable,
    SectionKind::D3D12RootParameterTable, SectionKind::D3D12ComputeExecutableTable,
    SectionKind::D3D12ComputeCommandTable, SectionKind::StringTable, SectionKind::DebugMap, SectionKind::Provenance};
static_assert(base::ValuesAreUnique(PackageSectionKinds, [](SectionKind value) { return std::to_underlying(value); }));
static_assert(base::ValuesAreStrictlyIncreasing(PackageSectionKinds, [](SectionKind value) { return std::to_underlying(value); }));
