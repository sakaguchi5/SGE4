...
struct PlanVerificationCertificate final
{
...
[[nodiscard]] base::Expected<SemanticObligation, std::string> BuildSemanticObligation(
...
[[nodiscard]] base::Digest256 ComputeVerificationSeal(const PlanVerificationCertificate& value);
[[nodiscard]] std::vector<std::byte> EncodeVerificationCertificate(const PlanVerificationCertificate& value);
[[nodiscard]] base::Expected<PlanVerificationCertificate, std::string> DecodeVerificationCertificate(
