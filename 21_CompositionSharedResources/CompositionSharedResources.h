...
struct SharedResourceRecord final
{
    ...
    std::shared_ptr<::sge4_5::runtime::IExternalResource> resource;
    std::shared_ptr<::sge4_5::runtime::ICompletionToken> availableAfter;
};
...
public:
    ...
    [[nodiscard]] std::shared_ptr<::sge4_5::runtime::IExternalResource> ResourceForEndpointHandle(CompositionEndpointId endpoint) const;
    [[nodiscard]] std::shared_ptr<::sge4_5::runtime::ICompletionToken> AvailableAfter(ResourceFlowId resource) const;
