...
SharedResourceError Error(const ::sge4_5::runtime::RuntimeError& value) { return {value.stage, value.message}; }
...
std::shared_ptr<::sge4_5::runtime::IExternalResource> SharedResourceTable::ResourceForEndpointHandle(CompositionEndpointId endpoint) const
{ const auto* r = Record(ResourceForEndpoint(endpoint)); return r ? r->resource : nullptr; }
std::shared_ptr<::sge4_5::runtime::ICompletionToken> SharedResourceTable::AvailableAfter(ResourceFlowId resource) const
...
base::Result<void, SharedResourceError> SharedResourceTable::UpdateAfterRelease(
    ...
    std::shared_ptr<::sge4_5::runtime::ICompletionToken> token)
{
...
{
    if (domain.State() != ::sge4_5::runtime::DeviceRuntimeState::Active || domain.DeviceEpoch() == 0)
